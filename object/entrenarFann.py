...
class CtrlEntrenarRNA:
	...
	def entrenar(self):
		...
		datos={"numerodeneuronas":self.__neuronas_capa_oculta,"error":self.__error_real,"tipo":"total"}
...
o.setNeuronasCapaOculta(25)
o.setErrorDeseado(0.9)
...
#Cambian el # de neuronas y error deseado
g.setNeuronasCapaOculta(40)
g.setErrorDeseado(0.9)
#Cambian el # de epocas
g.setEpocas(1000000)
g.setIteracionesEntreReporte(10000)
g.setUrlPrueba("rna_gamma.data")
g.entrenarGamma()
'''